...
public class UserDaoImpl implements UserDao {
    ...
    public void loadUserInfo() {
        ...
        // 设置用户群列表，共1个群
        GroupInfo groupInfo = new GroupInfo("01", "Group01", "../img/avatar/Group01.jpg");
    ...
    public UserInfo selectUserInfo(String username) {
        for(Map.Entry<String, UserInfo> entry : Constant.userInfoMap.entrySet()){
    ...
    @Override
    public UserInfo selectUserByUsernameAndPsd(LoginUser user) {
        UserInfo userInfo = Constant.userInfoMap.get(user.getUsername());
